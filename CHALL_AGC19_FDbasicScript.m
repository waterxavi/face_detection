...
load ./TRAINING/AGC19_Challenge1_Training
...
for j = 1 : length( AGC18_Challenge1_TRAINING )
    A = imread( sprintf('%s%s',...
        imgPath, AGC18_Challenge1_TRAINING(j).imageName ));    
...
FD_score = CHALL_AGC19_ComputeDetScores(...
    DetectionSTR, AGC18_Challenge1_TRAINING, 0);
